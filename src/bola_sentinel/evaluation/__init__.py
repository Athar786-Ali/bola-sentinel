...
truth, compute precision/recall/F1/FPR/FNR/coverage, quantify false-positive
reduction between stages, and write reproducible output (JSON metrics +
Markdown report + evaluation run log).
"""

from .comparator import run_progressive_comparison
from .ground_truth_loader import load_ground_truth_for_app, load_all_ground_truth
